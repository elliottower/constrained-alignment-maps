...
\subtitle{Structured sparse autoencoders for nonlinear causal discovery\\[0.3em]{\small Validated on 6 GPT-2 tasks from the MIB benchmark}}
\author{Elliot Tower}
\date{2026}
\institute{}
...
\begin{columns}[T]
\begin{column}{0.50\textwidth}
{\small Apply to \textbf{6 NLP tasks} in GPT-2-small, layer 8.}

\vspace{0.2em}
{\scriptsize Using MIB counterfactual pairs (Prakash et al.\ 2024):}
\begin{itemize}\setlength{\itemsep}{0pt}
  \item {\scriptsize \textbf{IOI}: indirect object identification (1,983 pairs)}
  \item {\scriptsize \textbf{SVA}: singular/plural agreement (varies)}
  ...
  \item {\scriptsize \textbf{Capitals}: country $\to$ capital (190 pairs, 182 classes)}
\end{itemize}

\vspace{0.2em}
{\scriptsize E2E training is the key --- without it, pi-SAE is mediocre.}
\end{column}
\begin{column}{0.48\textwidth}
...
\begin{tabular}{l|ccc}
\toprule
\textbf{Task} & \textbf{DAS} & \textbf{pi-SAE} & \textbf{E2E} \\
\midrule
\multicolumn{4}{c}{\textit{Standard IIA (strict IIA), $k = 1$}} \\
\midrule
IOI          & 0.19 (0.19) & 1.00 (1.00) & \textbf{1.00 (1.00)} \\
Gender bias  & 0.62 (0.52) & 0.39 (0.33) & \textbf{1.00 (1.00)} \\
Greater-than & 0.93 (0.28) & 0.37 (0.00) & \textbf{1.00 (1.00)} \\
SVA          & 0.92 (0.00) & 0.45 (0.00) & \textbf{1.00 (1.00)} \\
Hypernymy    & 0.07 (0.02) & 0.58 (0.17) & \textbf{0.97 (0.90)} \\
Capitals$^\dagger$ & 0.12 (---) & 0.19 (0.02) & \textbf{0.51 (0.26)} \\
\bottomrule
\end{tabular}
}

\vspace{0.2em}
{\scriptsize $^\dagger$182 classes, $\approx$1 example/class --- data limitation.}
\end{column}
\end{columns}
\end{frame}
...
\vspace{0.5em}
{\small \textbf{Result}: E2E achieves strict IIA $\geq 0.90$ on \textbf{5/6 GPT-2 tasks} at $k{=}1$.}

\vspace{0.3em}
{\small Dominates DAS on all six tasks. $14\times$ better on hypernymy.}
\end{column}
\begin{column}{0.50\textwidth}
{\scriptsize\centering
\renewcommand{\arraystretch}{1.15}
\textbf{All 6 GPT-2 tasks --- standard IIA (strict IIA), $k{=}1$}\\[0.3em]
\begin{tabular}{l|cc}
\toprule
\textbf{Task} & \textbf{DAS} & \textbf{E2E} \\
\midrule
IOI          & 0.19 (0.19) & \textbf{1.00 (1.00)} \\
Gender bias  & 0.62 (0.52) & \textbf{1.00 (1.00)} \\
Greater-than & 0.93 (0.28) & \textbf{1.00 (1.00)} \\
SVA          & 0.92 (0.00) & \textbf{1.00 (1.00)} \\
Hypernymy    & 0.07 (0.02) & \textbf{0.97 (0.90)} \\
Capitals$^\dagger$ & 0.12 (---) & \textbf{0.51 (0.26)} \\
\bottomrule
\end{tabular}
}

\vspace{0.3em}
{\scriptsize $^\dagger$182 classes, 190 examples ($\approx$1/class) --- data limitation, not method failure.}

\vspace{0.3em}
{\scriptsize All results: additive intervention, layer 8. Capitals from RAVEL benchmark.}
\end{column}
\end{columns}
\end{frame}
