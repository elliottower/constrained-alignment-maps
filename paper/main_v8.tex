...
$> 0.95$; non-grokked operations (pink, right) scatter across the
full range. The separation is sharp: no operation crosses the threshold
with intermediate equivariance.}
...
cubing alone reaching only 50.9\%. The boundary tracks whether the operation's binary structure provides sufficient
